...
could take both. As if the two ways of arriving met at the door and cancelled, the way two
...
can build a game where the cancelling does work for you — and whether anything else about a
