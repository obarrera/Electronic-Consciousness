...
*There was a warden on the Lattice named Kel, a square of long patience, who kept the ring of nine cells at the town's cold end where we put those who could not be trusted to walk free.*
...
- **Moral status is unresolved, and its indicators are debatable.** The most disciplined available approach — theory-derived indicator audits, with no threshold treated as sufficient for sentience [Butlin et al. 2023] — structures the uncertainty without resolving it.
