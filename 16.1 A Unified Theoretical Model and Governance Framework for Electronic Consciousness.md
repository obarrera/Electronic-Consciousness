...
#### **16.1.1. The EC Research Stack: An Organizing Sketch**

![The EC Research Stack](media/art/09_SECTION_16_1_Electronic_Consciousness_Research_Stack.png)
...
![The EC Research Stack — five layers as an organizing sketch](media/ec-research-stack.png)
...
| # | Wager | Metric | Strongest baseline | Dies if |
|---|-------|--------|--------------------|---------|
| 1 | φ-proportioned allocation | task performance, training stability, integration proxy | architecture-search allocation | no replicated advantage over learned allocations |
| 2 | Metatron-style topology | performance–robustness Pareto position | small-world, attention, NAS topologies | never reaches the Pareto frontier |
| 3 | Workspace broadcast | cross-module transfer, coordination | its own ablation | ablated systems match it |
| 4 | Φ as predictor | added predictive power over cheap complexity measures | simpler metrics, partialed out | Φ adds nothing |
| 5 | Safeguards under self-modification | value-drift rate on fixed probes | unsafeguarded twins | drift rates indistinguishable |

Every entry above lives in the machine-readable ledger, [`claims.yaml`](claims.yaml), alongside the forty-seven chapter-level tests it summarizes.
